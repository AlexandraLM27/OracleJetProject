 ...
 */
define(['../accUtils', "text!../details.json", "knockout", "ojs/ojmodulerouter-adapter", "ojs/ojarraydataprovider", "ojs/ojknockout", "ojs/ojlistview", "ojs/ojmodule-element"],
    function(accUtils, records, ko, ModuleRouterAdapter, ArrayDataProvider) {
       function CustomersViewModel(args) {
